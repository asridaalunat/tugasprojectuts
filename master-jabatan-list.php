                                        ...
                                        <tbody>
                                            ...
                                            if (empty($dataJabatan)) {
                                                ...
                                                foreach ($dataJabatan as $index => $jabatan) {
                                                    ...
                                                    $idValue = $jabatan['id'] ?? $jabatan['id_jabatan'] ?? $jabatan['kode'] ?? $jabatan['kode_jabatan'] ?? '';
                                                    $namaValue = $jabatan['nama'] ?? $jabatan['nama_jabatan'] ?? '';
                                                    $kodeValue = $jabatan['kode'] ?? $jabatan['kode_jabatan'] ?? '';
                                                    $deskripsiValue = $jabatan['deskripsi'] ?? '';
                                                    $levelValue = $jabatan['level_jabatan'] ?? $jabatan['level'] ?? '';

                                                    // Tentukan warna badge Level Jabatan
                                                    switch($levelValue){
                                                        case 1: $levelEsc = '<span class="badge bg-success">'.$levelValue.'</span>'; break;
                                                        case 2: $levelEsc = '<span class="badge bg-primary">'.$levelValue.'</span>'; break;
                                                        case 3: $levelEsc = '<span class="badge bg-warning text-dark">'.$levelValue.'</span>'; break;
                                                        case 4: $levelEsc = '<span class="badge bg-danger">'.$levelValue.'</span>'; break;
                                                        default: $levelEsc = '<span class="badge bg-secondary">'.$levelValue.'</span>'; break;
                                                    }
